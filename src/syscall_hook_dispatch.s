 ...
 * Brandon Azad
 *
 * x86-64 assembly for kernel_dispatch, the function we will shove into the kernel, and
 * syscall_kernel_call, the function we use to invoke the hooked syscall.
 */
...
.globl _syscall_kernel_call
.align 4
_syscall_kernel_call:
	pushq   %rbp
	movq    %rsp, %rbp
